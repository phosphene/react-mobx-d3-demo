import BarChartBrushExample from './BarChartBrushExample';
import React, {PropTypes} from 'react';
import ReactDOM from 'react-dom';


class BrushWrap extends React.Component {
  ...
  componentDidMount() {
    this.chart = new BarChartBrushExample();
    this.chart.render();
